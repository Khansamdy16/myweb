    ...
    <div class="container">
        ...
        <nav class="navbar bg-primary navbar-expand-lg " data-bs-theme="dark">
            ...
            <div class="container-fluid">
                <a class="navbar-brand" href="#">WEB PRODI</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo isset($_GET['page']) && $_GET['page'] == 'prodi' ? 'active' : '' ; ?>" aria-current="page" href="<?php echo base_url()."index.php?page=prodi"; ?>">Data Prodi</a>
                        </li>
                    </ul>
                </div>
            </div>
